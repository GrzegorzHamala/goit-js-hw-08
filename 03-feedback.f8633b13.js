...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector('input[name="email"]'),l=document.querySelector('textarea[name="message"]'),o=document.querySelector('button[type="submit"]'),r=document.querySelector(".feedback-form"),u="feedback-form-state",n=()=>{try{a.value=JSON.parse(localStorage.getItem(u)).email,l.value=JSON.parse(localStorage.getItem(u)).message}catch{console.log("Please enter your data!!!")}},s=()=>{let e={email:`${a.value}`,message:`${l.value}`};localStorage.setItem(u,JSON.stringify(e))},c=e=>{""!==a.value?(e.preventDefault(),console.log(JSON.parse(localStorage.getItem(u))),r.reset(),localStorage.removeItem(u)):(e.preventDefault(),console.log("NO DATA!!!"))};n(),a.addEventListener("input",(0,e.default)(s,500)),l.addEventListener("input",(0,e.default)(s,500)),o.addEventListener("click",c);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.f8633b13.js.map